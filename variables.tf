...
variable "storage_container_name" {
  ...
  default     = "appservicebackup1"
}

variable "storage_account_name" {
  type = string
  default = "teststrgacc1"  
}
...
variable "application_insights_id" {
  ...
  default     = "/subscriptions/4a9ac668-c3d5-4a20-859a-c680184367b8/resourceGroups/test-rg/providers/Microsoft.Insights/components/testai"
}

variable "application_insights_name" {
  description = "Specify the name for Application Insights"
  default     = "test-app-insights-1"
}
...
variable "application_insights_log_analytics_workspace_id" {
  ...
  type        = string
  default     = "/subscriptions/4a9ac668-c3d5-4a20-859a-c680184367b8/resourcegroups/test-rg/providers/microsoft.operationalinsights/workspaces/testlgw"
}
